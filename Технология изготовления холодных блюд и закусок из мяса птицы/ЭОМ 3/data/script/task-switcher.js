...
function RaschitatiBalli() {
    ...
    if(document.querySelector('.answer-7').value == "20" || document.querySelector('.answer-7').value == "20") ball++
    if(document.querySelector('.answer-8').value == "Галантин" || document.querySelector('.answer-8').value == "галантин") ball++
    if(document.querySelector('.answer-9').value == "Заливное из курицы" || document.querySelector('.answer-9').value == "заливное из курицы") ball++
    if(document.querySelector('.answer-10').value == "Суфле из мяса птицы" || document.querySelector('.answer-8').value == "суфле из мяса птицы") ball++
