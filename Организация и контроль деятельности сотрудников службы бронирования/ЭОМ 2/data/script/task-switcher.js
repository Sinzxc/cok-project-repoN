...
function RaschitatiBalli() {
    ...
    if(document.querySelector('.answer-9').value == "Бронирование" || document.querySelector('.answer-9').value == "бронирование") ball++
    if(document.querySelector('.answer-10').value == "Телефонный разговор" || document.querySelector('.answer-10').value == "телефонный разговор") ball++
