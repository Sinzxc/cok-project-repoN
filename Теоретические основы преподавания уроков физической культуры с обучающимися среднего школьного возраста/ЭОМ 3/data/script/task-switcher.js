...
function RaschitatiBalli() {
    ...
    if(document.querySelector('.answer-6-1').value == 2 && document.querySelector('.answer-6-2').value == 1 && document.querySelector('.answer-6-3').value == 4 && document.querySelector('.answer-6-4').value == 3) ball++
    ...
    if(document.querySelector('.answer-8').value == 'Спорт' || document.querySelector('.answer-8').value == 'спорт') ball++
    ...
    if(document.querySelector('.answer-10').value == 'здоровье' || document.querySelector('.answer-10').value == 'Здоровье') ball++
