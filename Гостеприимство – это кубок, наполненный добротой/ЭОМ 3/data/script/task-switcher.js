...
function RaschitatiBalli() {
    ...
    && document.querySelector('.true-answer-7-3').checked && document.querySelector('.true-answer-7-4').checked && document.querySelector('.true-answer-7-5').checked && document.querySelector('.true-answer-7-6').checked)  ball++
